...
public class CollectionExample {
	...
	public static void main(String...args) {
		...
		// if list has Null and if we perform any operation like sort, it throws NullPointerException
		...
		// sort in descending order using Collection.reverserOder()
		...
		// Collection.sort(new ArrayList<>(set));
		...
		// TreeSet class has descendingSet method which prints the elements in reverse order
		...
		// list with numbers, sort it in descending order using Collections.reverseOrder()
		...
		// By using Collections.unmodifiableList() method we can immutable list.
		// i.e., we cant add new element or we cant remove an existing element from the list
		...
		// But we can't achieve 100% immutablity here. Since we can modify content of existing
		// element inside the list. Lets try to change the content of obj2 in unModifiedList
		...
		System.out.println("-----Able to update existing element in unmodifiable list----100% immutablity is not achieved");
		System.out.println(unModifiedList);
	}
}
